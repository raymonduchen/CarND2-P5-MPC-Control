...
double ref_cte = 0;
double ref_epsi = 0;
double ref_v = 100;//40;  //Ref. velocity = 40 mph
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  //
  // 4 * 10 + 2 * 9
  size_t n_vars = N * 6 + (N - 1) * 2; // x, y, psi, v, cte, epsi ; delta, a
  ...
  // upper and lower limits of delta = -25, 25 degrees * Lf (values in radians)
